...
public class dispositivo_bt extends AppCompatActivity {

    //1)
    // Depuración de LOGCAT
    private static final String TAG = "dispositivo_bt"; //<-<- PARTE A MODIFICAR >->->
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dispositivo_bt);
    }
    ...
    private AdapterView.OnItemClickListener mDeviceClickListener = new AdapterView.OnItemClickListener() {
        public void onItemClick(AdapterView av, View v, int arg2, long arg3) {
            ...
            Intent i = new Intent(dispositivo_bt.this, MainActivity.class);//<-<- PARTE A MODIFICAR >->->
